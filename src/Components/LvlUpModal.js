    ...
    return (
        <>
            <div className="w-2/6 h-2/3 flex flex-col text-xl p-4 gap-2 justify-evenly items-center fixed z-20  top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-slate-50">
                ...
                <div className="w-full h-1/4 flex text-2xl justify-center items-center break-words px-2">
                    <h3>{name} you're level {lvl}.</h3>
                ...
                <div className="w-full h-20  flex flex-col gap-2 justify-center items-center">
                    <button
                        ...
                        className="w-2/3 h-12 bg-blue-400 rounded-md shadow-md shadow-blue-700 hover:border-2 border-blue-900 duration-100 ease-in-out ">Continue your journey</button>
